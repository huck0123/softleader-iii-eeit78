...
import tw.org.iiiedu.thegivers.model.RHistoryModel;

@Repository
public class RHistoryDao {
	@Autowired
	private DataSource datasource2;

	public RHistoryModel getById(Long id) {
		PreparedStatement prst = null;
		Connection conn = null;
		RHistoryModel rhm = null;
		try {
