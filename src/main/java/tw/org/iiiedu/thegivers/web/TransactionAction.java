...
public class TransactionAction extends ActionSupport {
	...
	public String donate() {
		...
		Integer transactionCount = (Integer) context
				.getAttribute("transactionCount");

		log.debug(
				"++++++++++++++++++++++++++++++donateAction++++++++++++form:{} transactionCount:{}",
		...
		try {
			...
			log.debug(
					"++++++++++++++transactionAction+++++++++++++ transactionCount:{}",
					transactionCount);
		...
		String chk6Num = "";
		for (int i = 0; i < 6; i++) {
			chk6Num += (int) (Math.random() * 10);
		}
		context.setAttribute("chk6Num", chk6Num);
		return SUCCESS;
	}
	...
	public String credit() {
		log.debug("*******************TransactionAction*******credit*****{}{}",
				thisId, credit);
	...
	public String giverDetailByCondition() {
		List<TransactionDetailModel> tdm = service
				.getByIdAndCondition(allCondition);
