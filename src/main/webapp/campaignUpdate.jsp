<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="col-md-10">
		<form action="/softleader-iii-eeit78/campaign/campaignAction!update"
			method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label for="campaign-name-input">id：</label> <input type="text"
					class="form-control" name="campaignForm.id"
					id="campaign-id-input" placeholder="請輸入活動id">
			</div>
			<div class="form-group">
